...
(function () {
    ...
    function createHeroBanner() {
        ...
        // CSS ekle
        if (!document.getElementById('ebitbet-hero-style')) {
            const style = document.createElement('style');
            style.id = 'ebitbet-hero-style';
            style.textContent = `
                .ebitbet-hero-banner {
                    width: 100%;
                ...
                .ebitbet-hero-banner .hero-left {
                    flex: 1 1 50%;
                    min-width: 280px;
                    padding-right: 20px;
                }

                .ebitbet-hero-banner .hero-left h1 {
                    font-size: 38px;
                    font-weight: bold;
                    margin-bottom: 16px;
                }

                .ebitbet-hero-banner .hero-left p {
                    font-size: 18px;
                    margin-bottom: 20px;
                }

                .ebitbet-hero-banner .cta-row {
                    margin-top: 20px;
                    display: flex;
                    align-items: center;
                    gap: 12px;
                ...
                .ebitbet-hero-banner .social-icons {
                    display: flex;
                    gap: 10px;
                }

                .ebitbet-hero-banner .social-icons a {
                    width: 44px;
                    height: 44px;
                    background: #2c2f38;
                    border-radius: 10px;
                ...
                .ebitbet-hero-banner .social-icons img {
                    width: 22px;
                    height: 22px;
                }

                .ebitbet-hero-banner .hero-right {
                    flex: 1 1 45%;
                    min-width: 280px;
                    display: flex;
                ...
                .ebitbet-hero-banner .hero-right img {
                    width: 100%;
                    max-width: 560px;
                    height: auto;
                    display: block;
